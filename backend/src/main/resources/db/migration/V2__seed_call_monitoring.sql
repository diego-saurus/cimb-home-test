INSERT INTO cs_agents (id, cs_name)
VALUES (1, 'Ahmad Wijaya'),
       (2, 'Citra Lestari'),
       (3, 'Eka Pratama');

INSERT INTO customers (id, customer_name)
VALUES (1, 'Budi Santoso'),
       (2, 'Dewi Anggraini'),
       (3, 'Fajar Nugroho');

INSERT INTO call_monitorings (call_id, call_timestamp, cs_agent_id, customer_id, sentiment_score)
VALUES ('CM-0001', TIMESTAMP '2025-05-01 09:30:00', 1, 1, 82.00),
